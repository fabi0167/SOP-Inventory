    ...
    public class ItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> ArchiveByIdAsync([FromRoute] int Id, [FromBody] ArchiveNoteRequest archiveNoteRequest)
        {
            try
            {
                ...
                Archive_Item archive_Item = new Archive_Item
                {
                    Id = item.Id,
        ...
        private ItemResponse MapItemToItemResponse(Item item)
        {
            ...
            if (item.StatusHistories != null)
            {
                response.StatusHistories =
                    item.StatusHistories.Select(statusHistory =>
                    {
                        var statisHistoryResponse = new ItemStatusHistoryResponse
                        {
                            Id = statusHistory.Id,
                        ...
                        {
                            statisHistoryResponse.Status = new ItemStatusResponse
                            {
